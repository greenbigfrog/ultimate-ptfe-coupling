There are a couple Magnet based PTFE coupling systems out there, to be used for 3D Printing. But they aren't necessarily all compatible, or allow for easily setting the magnet size.
